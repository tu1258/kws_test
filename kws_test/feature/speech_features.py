...
# from ..feature import normalizer 
# from ..feature import preemphasis 
from ..feature import windowing 
# import kws.layers.spectrogram_augment as spectrogram_augment
...
class SpeechFeatures(tf.keras.layers.Layer):
  ...
  def __init__(
      self,
      params,
      mode='TRAINING',  # layer with state has to have it
  ...
  def build(self, input_shape):
    ...
    # if self.noise_scale != 0.0 and self.mode == 'TRAINING':
